...
<section style="width:700px;margin: 0 auto;padding: 60px 0px 50px 0px;color: #0e1d34;background: #f6f6f6;">
  ...
  <div style="text-align:center;width: 380px;margin: 0 auto;">
    ...
    <h1 style="line-height: 1em;color: #0e1d34;font-weight: bold;font-size: 32px;
      margin-bottom: 20px;">
      YOU'VE MADE CHANGES TO YOUR<br><span style="font-weight: 700;color: #ec5210;">BigDataCorridor</span>
			ACCOUNT
    </h1>
    <!-- sign in small info -->
    <p style="line-height: 1.2em;color: #0e1d34;font-weight: bold;font-size:16px;">
      Your password has now been changed, view details below </p>
  </div>
<!-- </section> -->
...
<div style="margin-top: 50px;margin-bottom: 40px;">
  ...
  font-size: 14px;"><?php echo sprintf(lang('email_new_password_heading'), $identity);?></div>
</div>
<div style="margin-bottom: 20px;">
  <!-- content section -->
  <label style="color: #0e1d33;font-weight: bold;margin-bottom: 20px;display: block;">New Password</label>
  <div style="padding: 0px 20px 15px 0px;width: 100%;height: auto;font-family: Montserrat, sans-serif;
    font-size: 14px;"><?php echo sprintf(lang('email_new_password_subheading'), $new_password);?></div>
</div>
</div>
</section>
</body>

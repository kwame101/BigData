...
<div style="width: 700px;margin: 0 auto;background: #0e1d33;padding: 1.3rem 0;">
...
<section style="width:700px;margin: 0 auto;padding: 60px 0px 50px 0px;color: #0e1d34;background: #f6f6f6;">
  ...
  <!-- sign in button -->
  <a href="<?php echo site_url('admin/user/login'); ?>" style="padding: 10px 40px;height: 100%;font-family: 'Montserrat', sans-serif;

...
<div class="container">
  ...
  <div class="report_update">
      <div class="wrapper">
        <p>Generate members usage report</p> <a href="<?php echo site_url('admin/users/exportReportCSV');?>">Download as CSV</a> <br>
  ...
  <div class="wrapper">
    ...
    if(isset($users))
    {
      ...
      foreach($users as $user)
      {
        ...
        echo '<span style="width: 250px; line-height: 33px; color: #EC5310;">'.addTime($new_date).'</span>';
        echo '</div>';
        echo '</div></div>';
     }
     echo '</div>';
